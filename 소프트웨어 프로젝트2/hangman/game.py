...
class HangmanGame(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        font.setPointSize(font.pointSize()) #폰트 사이즈를 줄여 단어 모두 표시
    ...
    def guessClicked(self):
        ...
        if success == False:
            self.message.setText(self.hangman.decreaseLife())
            # 남아 있는 목숨을 1 만큼 감소
            # 메시지 출력
        ...
        if self.guess.finished():
            ...
            self.message.setText("Fail! secreat word = " + self.guess.secretWord)
            self.gameOver = True
