...
{
    // Distance the wall moves up or down
    [SerializeField]
    float moveDistance = 3f;

    // Speed the wall moves up or down
    [SerializeField]
    float moveSpeed = 2f;

    // Is the wall currently in the "raised" position?
    [SerializeField]
    bool raised = true;

    // Reference to the wall's audio source
    AudioSource audioSource;

    // Position the wall wants to move to
